...
require (
	...
	github.com/signalfx/splunk-otel-collector/pkg/extension/smartagentextension v0.61.3
	github.com/signalfx/splunk-otel-collector/pkg/processor/timestampprocessor v0.61.3
	github.com/signalfx/splunk-otel-collector/pkg/receiver/smartagentreceiver v0.61.3
