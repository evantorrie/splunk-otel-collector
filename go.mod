...
require (
	...
	github.com/signalfx/splunk-otel-collector/pkg/extension/smartagentextension v0.74.0-yahoo
	github.com/signalfx/splunk-otel-collector/pkg/processor/timestampprocessor v0.74.0-yahoo
	github.com/signalfx/splunk-otel-collector/pkg/receiver/smartagentreceiver v0.74.0-yahoo
	github.com/signalfx/splunk-otel-collector/tests v0.74.0-yahoo
